...
def handler(event, context):
    ...
    try:
        # 동기 스크래퍼 실행
        result = scrape_creativeengineering_advancedmaterials_academic()
        return {
            "statusCode": 200,
...
def scrape_creativeengineering_advancedmaterials_academic() -> Dict[str, Any]:
    """
    신소재공학부 학사공지를 스크래핑하고 새로운 공지사항을 처리
    """
    url = "https://cms.kookmin.ac.kr/mse/bbs/notice.do"
